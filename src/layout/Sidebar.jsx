...
export default function Sidebar() {
  const { sidebarOpen, toggleSidebar, darkMode, toggleDarkMode, layoutLocked, toggleLayoutLocked, setShowUsernameModal, focusRunning, setLeaveGuardPending, isDemo, exitDemo } = useUIStore(
    useShallow((s) => ({
      ...
      <div className="flex items-center justify-between px-4 h-14 shrink-0 border-b border-gray-200 dark:border-gray-800">
        {sidebarOpen && (
          <div className="flex items-center gap-2">
            <button onClick={() => { if (focusRunning) { setLeaveGuardPending('/'); } else { navigate('/'); } }} className="flex items-center gap-2 group">
